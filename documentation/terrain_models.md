...
* **`HARD`**: Extreme driving experience with highly pronounced peaks, valleys, and sharp spikes.
...
Selecting `RUGGED`, `SMOOTH`, or `HARD` automatically overwrites the wave amplitudes listed below.
...
| Component Name | Default (Hard) | Default (Rugged) | Default (Smooth) | Wave Function / Frequency | Purpose |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Mountains** | `300.0` | `220.0` | `130.0` | `sin(x * 0.0003)` | Broad long-range elevation rises. |
| **Long Hills** | `110.0` | `85.0` | `60.0` | `sin(x * 0.0007)` | Spaced-out rolling hills. |
| **Medium Waves** | `70.0` | `50.0` | `35.0` | `cos(x * 0.0013)` | Medium undulations. |
| **Smooth Spikes** | `85.0` | `65.0` | `15.0` | `sin(x * 0.0060)` | Rapid steep climbs. |
| **Sharp Dips** | `35.0` | `25.0` | `8.0` | `sin(x * 0.0030)` | Ground dips. |
| **Lil' Spikes** | `25.0` | `18.0` | `0.0` | `sin(x * 0.0220)` | Micro tire vibration spikes. |
| **Small Bumps** | `18.0` | `12.0` | `6.0` | `sin(x * 0.0080)` | Subtle surface noise. |
